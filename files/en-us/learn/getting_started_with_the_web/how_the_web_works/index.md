...
- **TCP/IP**: Transmission Control Protocol and Internet Protocol are communication protocols that define how data should travel across the internet. This is like the various routes you can use to move yourself to the shop and back to your house. It even allows you to split your groceries (data from servers) into many parts and send them home using different routes. Your address will be on each of the packages to make sure they're deliverd to the right house (client).
